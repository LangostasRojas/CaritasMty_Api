...
INSERT INTO BITACORA (idDonante, idRecolector, importe, fechaCobro, fechaVisita, estatusPago, estatusVisita, comentarios)
VALUES 
(1, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 1, 2, NULL),
(2, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 1, 2, NULL),
(3, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 2, 2, 1),
(4, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 1, 2, NULL),
(5, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 1, 2, NULL),
(6, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 1, 2, NULL),
(7, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 2, 2, 2),
(8, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 2, 2, 3),
(9, ROUND(RAND() * 3 + 3, 0), ROUND(RAND() * 700 + 200, 2), CONVERT(DATE, GETDATE()), NULL, 1, 2, NULL)
GO
